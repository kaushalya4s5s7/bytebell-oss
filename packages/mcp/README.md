...
fulltext vs. substring matching based on `match` and its own indexing
capabilities. Pagination packs matched-entity entries into pages until
a ~5000-token char budget is hit.
